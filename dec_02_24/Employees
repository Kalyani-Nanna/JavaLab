...
public class Employees
{
	...
	public static void main(String[] args) 
	{
		...
		Manager manager = new Manager( 101, "Chinna", 1500,5000,3000,5.5);
		manager.Display();
		...
		Trainer trainer= new Trainer(101,"Chainna", 1500,5000,3000,39,3.3);
		...
		Sourcing  sourcing = new Sourcing(101,"Chinna",-1500,5000,3000,0,0,0);
